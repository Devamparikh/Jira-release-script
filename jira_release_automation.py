...
def extract_jira_issue_ids():
    commit_message = subprocess.check_output('git log | awk "/release-please--branches--stable--components--release-please-action/{c++;if(c==2)exit} c==1"', shell=True).decode('utf-8')
